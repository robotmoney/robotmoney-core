...
// Canonical: docs/code-review/20260618-code-review-internal-claude.md §1 —
// duplicate basis-points denominator constants.
pragma solidity ^0.8.24;

/// @title BpsMath
/// @notice Single canonical basis-points denominator for the protocol. Fee,
...
///         compatibility.
library BpsMath {
    /// @notice The basis-points denominator: 100% expressed in basis points.
