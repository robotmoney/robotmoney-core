---
title: "RwaVault"
description: "ERC-4626 USDC vault holding Centrifuge deSPXA (tokenised S&P 500) on Base. Depositors receive rmRWA shares representing proportional NAV exposure to deSPXA. Prices are sourced from a Chronicle on-chain push oracle (not an Aerodrome TWAP). Entry and exit are via the Aerodrome secondary market swap ONLY."
---

# RwaVault

[Git Source](https://github.com/robotmoney/robotmoney-core/blob/294ae939cc4db43ac7ec7bac05d27e475246f588/contracts/vaults/RwaVault.sol)
...
<a id="constructor-ierc20-iswaprouter-ichronicleoracle-uint256-uint256-uint256-address-address-address"></a>
...
| swapRouter_ | `ISwapRouter` | Uniswap V3 SwapRouter (stub — not used for RWA swaps;<br/>all swaps go through ChronicleOracleAdapter/Aerodrome). |
...
<a id="setemergencyunwindstaleoverride-bool"></a>
...
<a id="_guardemergencyfreshness"></a>
