...
description: "ERC-4626 USDC vault holding a basket of agent-economy tokens curated via a governed shortlist. Swaps in/out via Uniswap V3."
---

# AgentTokenVault

[Git Source](https://github.com/robotmoney/robotmoney-core/blob/294ae939cc4db43ac7ec7bac05d27e475246f588/contracts/vaults/AgentTokenVault.sol)
