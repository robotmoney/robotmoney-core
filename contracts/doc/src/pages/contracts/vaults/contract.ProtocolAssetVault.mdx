...
description: "PROTOTYPE ERC-4626 USDC vault holding a basket of protocol assets (e.g. wETH, cbBTC, wSOL on Base) via Uniswap V3 swaps."
---

# ProtocolAssetVault

[Git Source](https://github.com/robotmoney/robotmoney-core/blob/0721b5607579ae8fe57f7d16428d23a62c533404/contracts/vaults/ProtocolAssetVault.sol)
...
<a id="constructor-ierc20-iswaprouter-uint256-uint256-uint256-address-address-address"></a>
...
Returns token address, pool, swap fee, active flag, and current vault
balance for every basket entry. Intended for off-chain display and
rmpc reads.

<i>

Issue #1364. The dapp classifies a vault as a basket from its registry
