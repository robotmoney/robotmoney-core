...
description: "Minimal IUniswapV3Pool stub for the smoke-test devnet price strip. Implements only `slot0()`. Full Uniswap V3 semantics (swap, mint, burn, observe, flash) are intentionally absent — the dapp only calls `slot0` to derive a mid-price."
---

# UniswapV3PoolSlot0Stub

[Git Source](https://github.com/robotmoney/robotmoney-core/blob/294ae939cc4db43ac7ec7bac05d27e475246f588/contracts/UniswapV3PoolSlot0Stub.sol)
