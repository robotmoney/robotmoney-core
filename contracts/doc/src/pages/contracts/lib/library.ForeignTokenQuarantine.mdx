...
description: "Shared logic for the permissionless foreign-token sweep that enforces custody invariants INV-1 and INV-2."
---

# ForeignTokenQuarantine

[Git Source](https://github.com/robotmoney/robotmoney-core/blob/294ae939cc4db43ac7ec7bac05d27e475246f588/contracts/lib/ForeignTokenQuarantine.sol)
...
<a id="sweep-address-address-address"></a>
