...
description: "Minimal Uniswap V4 pool interface consumed by UniswapV4SwapAdapter. V4 pools expose the same `observe(uint32[] secondsAgos)` TWAP interface as V3 (EIP-7680 compatibility), so the arithmetic-mean tick computation is identical to the V3 path in BasketVault._twapQuote()."
---

# IUniswapV4Pool

[Git Source](https://github.com/robotmoney/robotmoney-core/blob/294ae939cc4db43ac7ec7bac05d27e475246f588/contracts/interfaces/IUniswapV4Pool.sol)
