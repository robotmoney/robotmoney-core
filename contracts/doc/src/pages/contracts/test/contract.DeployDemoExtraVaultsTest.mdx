---
title: "DeployDemoExtraVaultsTest"
description: "Integration test for the demo seed path: after `DeployDemoExtraVaults` runs, rmPROTO (issue #559), rmAGENT (issue #560), and rmRWA (issue #621) are all router-eligible, the router carries a four-vault default weight vector (primary 8500 bps + rmRWA/rmPROTO/rmAGENT at 500 bps each), and a routed deposit reaches all four vaults. ADR-0002; issues #559, #560, #621. Also: deSPXA RWA vault is registered Active and router-eligible at 500 bps (ADR-0006 §1 amended 2026-06-05)."
---
...
| ---- | ---- | ----------- |
| d | `DeployDemoExtraVaults.Deployed` |  |

<a id="test_demo_seed_populates_defaultweights"></a>
...
<a id="test_rmagent_is_router_eligible"></a>
...
<a id="test_rmagent_holds_three_token_basket"></a>
...
<a id="test_rmagent_in_defaultweights"></a>
...
<a id="test_rmagent_basket_tokens_have_correct_venues"></a>
...
<a id="test_rmagent_deposit_increases_totalassets_via_multi_dex"></a>
...
<a id="_assertbnkrasset-agenttokenvault-deploydemoextravaults-deployed"></a>
...
<a id="_assertjunoasset-agenttokenvault-deploydemoextravaults-deployed"></a>
...
<a id="_assertrmasset-agenttokenvault-deploydemoextravaults-deployed"></a>
...
<a id="test_rmproto_is_router_eligible"></a>
...
<a id="test_rmproto_in_defaultweights"></a>
...
<a id="test_rmproto_router_deposit_succeeds"></a>
...
<a id="test_rwavault_is_active_after_demo_seed"></a>
...
<a id="test_rwavault_is_router_eligible"></a>
...
<a id="test_rwavault_in_defaultweights"></a>
...
<a id="test_four_vaults_all_active_with_nonzero_totalassets"></a>
...
<a id="test_rwavault_multi_deposit_does_not_overflow"></a>
...
<a id="test_rwavault_holds_despxa_asset_aerodrome_venue"></a>
