...
description: "Verifies the Aerodrome swap + TWAP adapter path in BasketVault. All tests use a mock AerodromeRouter and mock Aerodrome CL pool; no mainnet fork is required (issue #553 acceptance criterion: mocked/forked)."
---
...
<a id="test_aerodrome_deposit_routesthroughaerodromeadapter"></a>
...
<a id="test_aerodrome_withdrawal_routesthroughaerodromeadapter"></a>
...
<a id="test_aerodrome_v3defaultpathunchanged"></a>
...
<a id="test_aerodrome_totalassets_usesadaptertwap"></a>
...
<a id="test_aerodrome_deposit_slippagefloorfromadaptertwap"></a>
...
<a id="test_aerodrome_emergencyunwind_routesthroughadapter"></a>
...
<a id="test_aerodromeswapadapter_swap_revertsonslippage"></a>
...
<a id="test_aerodromeswapadapter_swap_forwardscallerdeadline"></a>
...
<a id="test_aerodromeswapadapter_twapprice_returnscorrectattickzero"></a>
...
<a id="test_aerodromeswapadapter_twapprice_revertsonpooltokenmismatch"></a>
...
<a id="test_aerodromeswapadapter_twapprice_revertsonzerowindow"></a>
...
<a id="test_aerodromeswapadapter_constructor_revertsonzerorouter"></a>
...
<a id="test_aerodromeswapadapter_constructor_revertsonzerofactory"></a>
