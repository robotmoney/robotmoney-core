...
description: "Pins invariant 11: a vault that became ineligible after being weighted cannot receive USDC at deposit time (runtime re-check via _requireRouterEligible inside _executeLegs)."
---
...
<a id="test_invariant11_deposit_skipsvaultthatloseseligibilityafterweighting"></a>
...
<a id="test_invariant11b_setweights_rejectsineligiblevault"></a>
