...
[Git Source](https://github.com/robotmoney/robotmoney-core/blob/6a5a4efb7af758963b9507b608985ed6f60e373a/contracts/test/DeployTimelock.t.sol)
...
### vaultEmergencyHolders

```solidity
address[] internal vaultEmergencyHolders;
```

### deployerAdminRevoked
...
<a id="test_deployer_heldandlostadminroleoneverygovernedcontract"></a>

### test_deployer_heldAndLostAdminRoleOnEveryGovernedContract

After role transfer, the deployer — the address that held
...
<a id="test_deployer_nolongerhasadminroleonanygovernedcontract"></a>

### test_deployer_noLongerHasAdminRoleOnAnyGovernedContract
