...
description: "Registry of admin-allowlisted committee agents and their signed allocation votes over the existing four-vault model."
---

# InvestmentCommitteePolicy

[Git Source](https://github.com/robotmoney/robotmoney-core/blob/294ae939cc4db43ac7ec7bac05d27e475246f588/contracts/gateway/InvestmentCommitteePolicy.sol)
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| p | `VoteParams` | All vote fields packed into a `VoteParams` struct to keep<br/>the stack frame within the EVM's 16-slot limit. |
