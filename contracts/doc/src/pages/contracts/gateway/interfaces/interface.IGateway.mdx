...
[Git Source](https://github.com/robotmoney/robotmoney-core/blob/294ae939cc4db43ac7ec7bac05d27e475246f588/contracts/gateway/interfaces/IGateway.sol)
...
| owner | `address` | Depositor EOA that authorized the agent<br/>(`msg.sender` at first `authorizeAgent` call). |
