---
title: "AccessRoles"
description: "Role constants and AccessControl wiring for the RobotMoney gateway."
---

# AccessRoles

[Git Source](https://github.com/robotmoney/robotmoney-core/blob/294ae939cc4db43ac7ec7bac05d27e475246f588/contracts/gateway/AccessRoles.sol)
...
`ADMIN` role tiers before any grant takes
...
<a id="_assertroleseparation-address"></a>
...
from any two of the `ADMIN` tiers
