...
description: "Admin-weighted MVP governance module that controls Portfolio Router target weights. ADMIN_ROLE assigns voting power to addresses, creates proposals, and executes after quorum is reached and the execution delay elapses. This is an MVP mock — voting power is admin-assigned, not derived from token holdings. Token-holder voting is a future goal."
---

# RouterGovernance

[Git Source](https://github.com/robotmoney/robotmoney-core/blob/3e58819955536f714395fd3acf63c345b6ac3362/contracts/RouterGovernance.sol)
...
Minimum quorum threshold. More than one unit of voting power
...
<a id="constructor-address-address-uint64-uint64-uint256"></a>
...
<a id="setquorumthreshold-uint256"></a>
...
<a id="setexecutiondelay-uint64"></a>
...
<a id="setvotingpower-address-uint256"></a>
...
<a id="propose-address-uint256"></a>
...
| executableAfter | `uint64` |  |
| votesFor | `uint256` |  |
| snapshotQuorum | `uint256` |  |
| executed | `bool` |  |
| cancelled | `bool` |  |

<a id="cadenceparams"></a>
...
| _executionDelay | `uint64` |  |
| _quorumThreshold | `uint256` |  |
| _totalVotingPower | `uint256` |  |

<a id="currentweights"></a>
...
<a id="hasvoted-uint256-address"></a>
...
<a id="proposalvotesnapshot-uint256"></a>
...
<a id="getpastvotes-address-uint256"></a>
...
<a id="_getpastvotes-address-uint256"></a>
