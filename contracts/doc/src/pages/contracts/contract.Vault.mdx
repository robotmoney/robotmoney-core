...
[Git Source](https://github.com/robotmoney/robotmoney-core/blob/82c1c2dc7d20af53bfb9d50a2efd80ad0cb8a34a/contracts/Vault.sol)
...
<a id="_route-uint256-bool"></a>

### _route

<i>

The two-pass body both allocators share. Pass 1 bounds each active
...
<a id="_allocatepass-uint256-uint256-uint256-uint256-bool"></a>

### _allocatePass

<i>

The one allocator loop every pass of both allocators runs: walk the
...
<a id="_equalweightbalance-uint256-uint256-uint256"></a>

### _equalWeightBalance

<i>

The `rank`-th active adapter's slice of `total` when `active`
...
<a id="_targetbpsforindex-uint256"></a>

### _targetBpsForIndex

<i>

Equal-weight target in bps for the adapter at registry `index`, or 0
...
The FLOORED base share, `MAX_BPS / activeAdapterCount()`. It is a
