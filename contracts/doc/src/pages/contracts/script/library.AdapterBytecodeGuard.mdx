...
description: "Deploy-time / test-time invariant that approved RobotMoneyVault strategy adapters are direct deployments whose runtime bytecode contains no `DELEGATECALL` opcode."
---

# AdapterBytecodeGuard

[Git Source](https://github.com/robotmoney/robotmoney-core/blob/294ae939cc4db43ac7ec7bac05d27e475246f588/contracts/script/AdapterBytecodeGuard.sol)
...
<a id="_codelengthwithoutmetadata-bytes"></a>
