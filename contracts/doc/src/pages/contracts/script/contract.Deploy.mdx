---
title: "Deploy"
description: "Foundry deploy script for the Robot Money gateway stack. Deploys RobotMoneyVault wired to real Aave V3, Compound V3, and Morpho strategy adapters (Base mainnet protocol addresses), a RobotMoneyGateway bound to the vault, grants AGENT_ROLE to a distinct EOA via `authorizeAgent`, asserts role-separation, and writes a deployment JSON."
---

# Deploy

[Git Source](https://github.com/robotmoney/robotmoney-core/blob/294ae939cc4db43ac7ec7bac05d27e475246f588/contracts/script/Deploy.s.sol)
...
<a id="runinprocesswith-address-address-address-address-address"></a>
...
<a id="runinprocesswithseed-address-address-address-address-address"></a>
...
<a id="_approveandregisteradapters-deployed"></a>
...
<a id="_executeseeddeposit-deployed"></a>
...
<a id="_approveadapter-robotmoneyvault-address"></a>
...
<a id="_asserttickmathcanonical"></a>
...
<a id="_authorizedeployagent-deployed-params"></a>
...
<a id="_envordefault-string-uint256"></a>
...
| shareReceiver | `address` |  |
| validUntil | `uint64` |  |
| maxPerPayment | `uint256` |  |
| maxPerWindow | `uint256` |  |
| maxWithdrawPerPayment | `uint256` |  |
| maxWithdrawPerWindow | `uint256` |  |
| usdcAddress | `address` |  |
