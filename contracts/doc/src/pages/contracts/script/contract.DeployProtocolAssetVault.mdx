...
description: "Production deploy script for `ProtocolAssetVault` (PRD §11.2 — rmPROTO). Deploys the vault, registers it in `VaultRegistry`, and emits the deployed address. Router eligibility activation is intentionally separated into `ActivateBasketVaultEligibility.s.sol`."
---

# DeployProtocolAssetVault

[Git Source](https://github.com/robotmoney/robotmoney-core/blob/294ae939cc4db43ac7ec7bac05d27e475246f588/contracts/script/DeployProtocolAssetVault.s.sol)
...
<a id="_deployandregister-address-address-address-address-uint256-uint256-uint256-address"></a>
