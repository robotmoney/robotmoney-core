...
description: "Foundry deploy script for the InvestmentCommitteePolicy contract."
---

# DeployInvestmentCommitteePolicy

[Git Source](https://github.com/robotmoney/robotmoney-core/blob/294ae939cc4db43ac7ec7bac05d27e475246f588/contracts/script/DeployInvestmentCommitteePolicy.s.sol)
...
<a id="runinprocesswith-address-address"></a>
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| admin_ | `address` | Address to receive DEFAULT_ADMIN_ROLE and ADMIN_ROLE on IC.<br/>Must also hold ADMIN_ROLE on the gateway. |
...
<a id="runinprocesswith-address-address-address"></a>
...
<a id="wiregatewayinprocess-deployed"></a>
...
<a id="_deploy-address-address-address"></a>
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| policy | `InvestmentCommitteePolicy` |  |
