...
// Canonical: none — third-party ABI surface (Aerodrome Finance CL pool on Base)
pragma solidity ^0.8.24;

/// @notice Minimal Aerodrome concentrated-liquidity (CL) pool interface for TWAP reads
...
interface IAerodromePool {
    ...
    /// @dev Aerodrome Slipstream (`CLPool`) `slot0` is a 6-field public struct —
    ...
    /// @notice Returns tick cumulatives and seconds-per-liquidity cumulatives
