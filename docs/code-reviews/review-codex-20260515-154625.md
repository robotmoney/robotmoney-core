...
**Primary anchors:** `docs/prd.md`, `docs/architecture.md`, `docs/security-model.md`, `docs/testing/ci-suites.md`.
...
**Recommendation:** Add `testing/README.md` with a matrix: suite, owner domain, command, CI workflow, required services/secrets, and product promise covered. Link each suite back to `docs/testing/ci-suites.md`.
