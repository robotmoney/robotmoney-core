...
| 0007 | [Vault retirement — no assisted migration; withdraw-only behavior is acceptable for production](ADR-0007-vault-retirement-no-assisted-migration.md) | Accepted |
