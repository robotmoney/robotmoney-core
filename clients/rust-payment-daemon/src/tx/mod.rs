...
/// Returns [`RmpdError::ErrRpcDecode`] only on protocol violations; an
/// exhausted budget surfaces as [`RmpdError::ErrRpcTransport`] with a
...
pub async fn wait_for_receipt_with(
    ...
    Err(RmpdError::ErrRpcTransport(format!(
